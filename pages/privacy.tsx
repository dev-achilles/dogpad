...
import { contentStyles, LayoutLegal } from "../src/common/LayoutLegal";

export default function Privacy() {
  return (
    <LayoutLegal title="Privacy Policy">
      <Content />
    </LayoutLegal>
  );
}
...
function Content() {
  return (
    <div className={contentStyles.content}>
      ...
      <p className="text-center">Last Updated: [Aug 2, 2021]</p>
      <section>
        <p>
          This Privacy Policy describes how Blokpad (referred to herein as
          "Blokpad", "we", "us" or "our"), a company formed pursuant to the laws
          of the IOM, will manage end user’s personal data collected. This
          Policy, in consonance with our Terms, applies to your use of Blokpad
          platform.
        </p>
        <p>
        ...
        <p>
          Blokpad is committed to respecting your privacy and ensuring that the
          personal data we collect about you is protected and is used, stored
          and disclosed in accordance with this Privacy Policy. Please read this
          Policy carefully to understand our practices regarding your personal
          data and how we will treat it. If you do not agree with this Privacy
          Policy, please do not use our services or provide Blokpad platforms
      ...
      <section>
        <div>
          ...
          <p>
            1.1. Blokpad will collect your Personal Data only by lawful and fair
            means for the following purposes. One or more purposes may apply
            simultaneously.
          </p>
          ...
          <ul>
            ...
            <li> To update you on technical progress of Blokpad;</li>
            <li>
              To contact you in relation to the management and administration of
              your Blokpad account
            </li>
            <li>
            ...
            <li>
              To take appropriate action if Blokpad has reason to suspect that
              unlawful activity or misconduct of a serious nature has been, is
              being or may be engaged in that relates to our functions and
              activities;
            </li>
            <li> To comply with a legal or regulatory obligation.</li>
          </ul>
          <p>
            1.2. You may choose to deal with us on an anonymous basis or to use
            a pseudonym unless it is not practicable for us to deal with
            ...
            Blokpad with the Personal Data we request, we may be unable to
            process your request to become a User, provide you with our services
            or respond to your enquiry or complaint. Examples of Personal Data
            That may be collected by Blokpad include your name, email address,
            telephone numbers, your date of birth, other verification
            information such as your Service usage activities. By becoming a
            User or otherwise choosing to provide Blokpad with Personal Data You
            consent to Blokpad collecting, using and disclosing your Personal
            Data For the above purposes.
          </p>
        </div>
        <div>
          <h2>2. Types of Data We Collect</h2>
          <p>
            2.1. The types of Personal Data that Blokpad may collect from you
            are:
          </p>
          <ul>
            <li>
          ...
          <p>
            2.2. With regard to each of your visits to our Blokpad platform and
            access to the services we may automatically collect the following
            information:
          </p>
          ...
          <ul>
            ...
            <li>
              ...
              Locators (URL) clickstream to, through and from the Blokpad
            ...
            <li>
              Information regarding the provision of Blokpad services we might
        ...
        <div>
          ...
          <p>
            3.1. You directly provide Blokpad with most of the data we collect.
            We collect data and process data when you:
          </p>

          <ul>
            <li> Register online and use the Blokpad platform services;</li>
            <li>
        ...
        <div>
          ...
          <p>
            4.1. Blokpad will take all reasonable steps to ensure that the
            Personal Data which it collects, uses or discloses is correct and is
            stored in a secure environment which is accessed only by authorised
            persons.
          </p>
          <p>
            4.2. Blokpad will destroy or permanently de-identify the Personal
        ...
        <div>
          ...
          <p>
            ...
            of electronic storage is totally secure. Therefore, we cannot
            warrant its absolute security of any information which you transmit.
            Any information which you transmit to Blokpad is transmitted at your
            own risk.
          </p>
          <p>
          ...
          <p>
            ...
            protected systems and databases and security technology. Blokpad
        ...
        <div>
          ...
          <p>
            Under certain circumstances, Blokpad may be required to disclose
        ...
        <div>
          ...
          <p>
            You are aware that if Blokpad is ever involved in a merger,
